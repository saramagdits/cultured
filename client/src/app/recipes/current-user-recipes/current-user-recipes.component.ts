...
@Component({
  selector: 'app-current-user-recipes',
  templateUrl: './current-user-recipes.component.html',
  styleUrls: ['./current-user-recipes.component.css']
})
export class CurrentUserRecipesComponent implements OnInit, OnChanges {
  private recipes;
  public cards;
  public rowHeight;
  public layoutMode = '';
